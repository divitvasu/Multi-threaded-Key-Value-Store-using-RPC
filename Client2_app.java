...
public class Client2_app {
    ...
    static                                //static block for formatter output and logger
    {
        ...
        lgm = Logger.getLogger((Client2_app.class.getClass().getName()));
    }

    private static void filing_logging() throws Exception{      //handling output of logger into a file

        fhl = new FileHandler("./Client2logs.log");
    ...
    public static void main(String args[]) throws Exception {
        ...
        Key_Store_Int send_data = (Key_Store_Int) registry.lookup("Key_Store_Int_Imp");   //server
        ...
        for (int i = 6; i <= 10; i++) {                         //5 pre-defined operations as required by the question

            String k = String.valueOf(i);
            char v = (char) ((char) i + 70);
